...
tls.elevator - Basic elevator simulator. Currently configured for a six floor building with four elevators. Two of the
	...
	An example of this is Elevator 1 which services the pickup going up on Floor 1. Since the passenger did not press a floor
	to go to and all other passenger pickups have been serviced by other elevators, Elevator 1 sits idle on Floor 1 after the 1st
	iteration. If Elevator 1, as part of iteration 2, had the passenger pressed a floor number button (like floor 3) to go to,
